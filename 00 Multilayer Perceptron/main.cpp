...
public:
  MLP(const size_t in_features, const size_t n_hidden_layers,
      const size_t hidden_dim, const size_t out_features) {
  ...
  size_t parameters_count() { return n_parameters; }
};
